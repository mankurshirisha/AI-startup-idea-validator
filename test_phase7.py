...
mock_raw_res.output_text = "   ### Answer\nYour SWOT looks strong.   "
mock_client_success.interactions.create.return_value = mock_raw_res
...
mock_raw_empty.output_text = "   "
mock_client_empty.interactions.create.return_value = mock_raw_empty
...
# 3. Character Limit Enforcement (>3000 chars - safely truncated)
mock_client_long = MagicMock()
mock_raw_long = MagicMock()
mock_raw_long.output_text = "A" * 3005
mock_client_long.interactions.create.return_value = mock_raw_long

gateway_long = LLMGateway(gemini_client=mock_client_long)
res_long = gateway_long.generate(prompt_pkg)
...
mock_client_timeout.interactions.create.side_effect = Exception("Request timed out after 20s")
...
mock_client_retry.interactions.create.side_effect = [
...
assert mock_client_retry.interactions.create.call_count == 2
